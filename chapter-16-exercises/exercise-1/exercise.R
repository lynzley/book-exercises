...
ggplot(diamonds_sample) +
  geom_point(
    mapping = aes(x = price, y = position)
  )
...
ggplot(diamonds_sample) +
  geom_point(
    mapping = aes(x = price, y = position, color = clarity)
  )
...
geom_point(
  mapping = aes(x = price, y = position, color = blue)
)

# Draw a scatter plot for `diamonds_sample` of `price` by `carat`, where each
# point has an aesthetic _shape_ based on the diamond's `cut`.
geom_point(
  mapping = aes(x = price, y = position, color = cut)
)
...
geom_point(
  mapping = aes(x = price, y = position, color = price)
)

# Try coloring the above plot based on the diamond's price!
geom_point(
  mapping = aes(x = price, y = position, color = price, color)
)
